...
void main() {
  group('ConfidenceThresholdInjector Unit Tests', () {
    ...
    test(
      '7. inject throws AIInferenceError if confidence is below threshold',
      () async {
        final injector = ConfidenceThresholdInjector(
          model: mockModel,
          threshold: 0.99,
        ...
        await expectLater(injector.inject(), throwsA(isA<AIInferenceError>()));
    ...
    test(
      '8. inject completes normally if confidence is above threshold',
      () async {
        final injector = ConfidenceThresholdInjector(
          model: mockModel,
          threshold: 0.9,
